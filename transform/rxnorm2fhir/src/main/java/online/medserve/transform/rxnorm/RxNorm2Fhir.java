package online.medserve.transform.rxnorm;
...
import online.medserve.transform.processor.FhirServerMedicationResourceProcessor;
import online.medserve.transform.processor.FileWritingMedicationResourceProcessor;

public class RxNorm2Fhir {
    ...
    private static final Logger logger = Logger.getLogger(RxNorm2Fhir.class.getCanonicalName());
    ...
    public static void main(String args[]) throws IOException, URISyntaxException {
        ...
        options.addOption(Option.builder(INPUT_FILE_OPTION)
            .longOpt("inputFile")
            .argName("RXNORM_ZIP_FILE_PATH")
            .hasArg()
            .desc("Input RxNorm release ZIP file")
            .required(true)
            .build());
        ...
        try {
            ...
            RxNormMedicationResourceGenerator generator = new RxNormMedicationResourceGenerator(
            ...
            formatter.printHelp("RxNorm2Fhir", options);
        }
