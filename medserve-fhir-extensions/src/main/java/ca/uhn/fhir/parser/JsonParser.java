...
public class JsonParser extends BaseParser implements IJsonLikeParser {
    ...
    static {
        System.out.println("WARNING :- HAPI class patch for JsonParser in play");
    }
    ...
    public void doEncodeResourceToJsonLikeWriter(IBaseResource theResource, JsonLikeWriter theEventWriter)
            throws IOException {
        if (myPrettyPrint) {
    ...
    public <T extends IBaseResource> T doParseResource(Class<T> theResourceType, JsonLikeStructure theJsonStructure) {
        ...
        ParserState<? extends IBaseResource> state =
                ParserState.getPreResourceInstance(this, theResourceType, myContext, true, getErrorHandler());
    ...
    private void encodeChildElementToStreamWriter(RuntimeResourceDefinition theResDef, IBaseResource theResource,
            JsonLikeWriter theEventWriter, IBase theNextValue,
            BaseRuntimeElementDefinition<?> theChildDef, String theChildName, boolean theContainedResource,
            boolean theSubResource, CompositeChildElement theChildElem,
        ...
        switch (theChildDef.getChildType()) {
            ...
            case COMPOSITE_DATATYPE: {
                ...
                encodeCompositeElementToStreamWriter(theResDef, theResource, theNextValue, theEventWriter,
                    theContainedResource, theSubResource, theChildElem);
            ...
            case CONTAINED_RESOURCES: {
                ...
                if (containedResources.size() > 0) {
                    ...
                    for (IBaseResource next : containedResources) {
                        ...
                        encodeResourceToJsonStreamWriter(theResDef, next, theEventWriter, null, true, false,
    ...
    private void encodeCompositeElementChildrenToStreamWriter(RuntimeResourceDefinition theResDef,
            IBaseResource theResource, IBase theElement, JsonLikeWriter theEventWriter,
        ...
        for (CompositeChildElement nextChildElem : super.compositeChildIterator(theElement, theContainedResource,
            theSubResource, theParent)) {

            BaseRuntimeChildDefinition nextChild = nextChildElem.getDef();

            if (nextChildElem.getDef().getElementName().equals("extension")
                    || nextChildElem.getDef().getElementName().equals("modifierExtension")
                    || nextChild instanceof RuntimeChildDeclaredExtensionDefinition) {
                if (!haveWrittenExtensions) {
                    extractAndWriteExtensionsAsDirectChild(theElement, theEventWriter,
                        myContext.getElementDefinition(theElement.getClass()), theResDef, theResource, nextChildElem,
                        theParent);
            ...
            if (nextChild instanceof RuntimeChildNarrativeDefinition) {
                ...
                if (gen != null) {
                    ...
                    if (narr != null && narr.isEmpty()) {
                        ...
                        if (!narr.isEmpty()) {
                            ...
                            encodeChildElementToStreamWriter(theResDef, theResource, theEventWriter, narr, type,
                ...
                encodeChildElementToStreamWriter(theResDef, theResource, theEventWriter, null, child, childName,
                    theContainedResource, theSubResource, nextChildElem, false);
                continue;
            }
            ...
            for (IBase nextValue : values) {
                ...
                if ((childDef.getChildType() == ChildTypeEnum.CONTAINED_RESOURCES
                        || childDef.getChildType() == ChildTypeEnum.CONTAINED_RESOURCE_LIST) && theContainedResource) {
                    continue;
                }
                ...
                if (currentChildName == null || !currentChildName.equals(childName)) {
                    ...
                    if (nextChild.getMax() > 1 || nextChild.getMax() == Child.MAX_UNLIMITED) {
                        ...
                        encodeChildElementToStreamWriter(theResDef, theResource, theEventWriter, nextValue, childDef,
                            null, theContainedResource, theSubResource, nextChildElem, force);
                    ...
                    encodeChildElementToStreamWriter(theResDef, theResource, theEventWriter, nextValue, childDef, null,
                        theContainedResource, theSubResource, nextChildElem, force);
                }
            ...
            if (!extensions.isEmpty() || !modifierExtensions.isEmpty() || !comments.isEmpty()) {
                ...
                for (int i = 0; i < valueIdx; i++) {
                    ...
                    if (modifierExtensions.size() > i && modifierExtensions.get(i) != null
    ...
    private void encodeCompositeElementToStreamWriter(RuntimeResourceDefinition theResDef, IBaseResource theResource,
            IBase theNextValue, JsonLikeWriter theEventWriter, boolean theContainedResource, boolean theSubResource,
        ...
        encodeCompositeElementChildrenToStreamWriter(theResDef, theResource, theNextValue, theEventWriter,
            theContainedResource, theSubResource, theParent);
    }

    @Override
    public void encodeResourceToJsonLikeWriter(IBaseResource theResource, JsonLikeWriter theJsonLikeWriter)
        ...
        if (theResource.getStructureFhirVersionEnum() != myContext.getVersion().getVersion()) {
            throw new IllegalArgumentException(
                "This parser is for FHIR version " + myContext.getVersion().getVersion()
                        + " - Can not encode a structure for version " + theResource.getStructureFhirVersionEnum());
        }

        doEncodeResourceToJsonLikeWriter(theResource, theJsonLikeWriter);
    }

    private void encodeResourceToJsonStreamWriter(RuntimeResourceDefinition theResDef, IBaseResource theResource,
            JsonLikeWriter theEventWriter, String theObjectNameOrNull,
        ...
        encodeResourceToJsonStreamWriter(theResDef, theResource, theEventWriter, theObjectNameOrNull,
            theContainedResource, theSubResource, resourceId);
    }
    ...
    private void encodeResourceToJsonStreamWriter(RuntimeResourceDefinition theResDef, IBaseResource theResource,
        ...
        if (theResourceId != null && theResourceId.hasIdPart()) {
            ...
            if (theResourceId.hasFormatComment() || haveExtension) {
                ...
                if (haveExtension) {
                    writeExtensionsAsDirectChild(theResource, theEventWriter, theResDef, extensions,
                        modifierExtensions);
                }
                theEventWriter.endObject();
            }
            ...
            if (super.shouldEncodeResourceMeta(resource)
                ...
                if (securityLabels.isEmpty() == false) {
                    ...
                    for (BaseCodingDt securityLabel : securityLabels) {
                        theEventWriter.beginObject();
                        encodeCompositeElementChildrenToStreamWriter(resDef, resource, securityLabel, theEventWriter,
                            theContainedResource, theSubResource, null);
                        theEventWriter.endObject();
                    }
                    theEventWriter.endArray();
                }
        ...
        encodeCompositeElementToStreamWriter(theResDef, theResource, theResource, theEventWriter, theContainedResource,
            theSubResource, new CompositeChildElement(resDef, theSubResource));
     ...
     * @param theParent
     */
    private void extractAndWriteExtensionsAsDirectChild(IBase theElement, JsonLikeWriter theEventWriter,
            BaseRuntimeElementDefinition<?> theElementDef, RuntimeResourceDefinition theResDef,
            IBaseResource theResource, CompositeChildElement theChildElem, CompositeChildElement theParent)
            throws IOException {
    ...
    private void extractDeclaredExtensions(IBase theResource, BaseRuntimeElementDefinition<?> resDef,
    ...
    private void extractUndeclaredExtensions(IBase theElement, List<HeldExtension> extensions,
            List<HeldExtension> modifierExtensions, CompositeChildElement theChildElem,
            CompositeChildElement theParent) {
    ...
    private JsonLikeArray grabJsonArray(JsonLikeObject theObject, String nextName, String thePosition) {
        ...
        if (!object.isArray()) {
            throw new DataFormatException("Syntax error parsing JSON FHIR structure: Expected ARRAY at element '"
    ...
    // continue;
    // }
    // throw new DataFormatException("Content does not appear to be FHIR JSON, first non-whitespace character was: '" +
    ...
    private void parseAlternates(JsonLikeValue theAlternateVal, ParserState<?> theState, String theElementName,
        ...
        if (theAlternateVal.isArray()) {
            ...
            if (array.size() > 1) {
                throw new DataFormatException(
                    "Unexpected array of length " + array.size() + " (expected 0 or 1) for element: " + theElementName);
            }
            if (array.size() == 0) {
                return;
            }
        ...
        if (alternateVal.isObject() == false) {
            getErrorHandler().incorrectJsonType(null, theAlternateName, ValueType.OBJECT, null,
        ...
        for (String nextKey : alternate.keySet()) {
            ...
            if ("extension".equals(nextKey)) {
                ...
                if (nextVal.isString()) {
                    ...
                    getErrorHandler().incorrectJsonType(null, "id", ValueType.SCALAR, ScalarType.STRING,
                        nextVal.getJsonType(), nextVal.getDataType());
                }
                ...
                if (alternateName.startsWith("_") && alternateName.length() > 1) {
                    ...
                    if (nextValue != null) {
                        if (nextValue.isObject()) {
                            ...
                            getErrorHandler().incorrectJsonType(null, alternateName, ValueType.OBJECT, null,
                                nextValue.getJsonType(), null);
                        }
                    }
                }
            }
    ...
    private void parseChildren(ParserState<?> theState, String theName, JsonLikeValue theJsonVal,
            JsonLikeValue theAlternateVal, String theAlternateName, boolean theInArray) {
        if (theName.equals("id")) {
            if (!theJsonVal.isString()) {
                getErrorHandler().incorrectJsonType(null, "id", ValueType.SCALAR, ScalarType.STRING,
                    theJsonVal.getJsonType(), theJsonVal.getDataType());
            }
        }
        ...
        if (theJsonVal.isArray()) {
            ...
            if (alternateVal != null && alternateVal.isArray() == false) {
                getErrorHandler().incorrectJsonType(null, theAlternateName, ValueType.ARRAY, null,
                    alternateVal.getJsonType(), null);
                alternateVal = null;
            }
    ...
    @Override
    public <T extends IBaseResource> T parseResource(Class<T> theResourceType, JsonLikeStructure theJsonLikeStructure)
        ...
        if ("Bundle".equals(def.getName())) {
            ...
            if (entries != null) {
                for (IBase nextEntry : entries) {
                     ...
                     */
                    // TODO: should emit a warning and maybe notify the error handler if the resource ID doesn't match
                    // the
                    // fullUrl idPart
                    ...
                    if (fullUrl != null && !fullUrl.isEmpty()) {
                        ...
                        if (value.isEmpty() == false) {
                            List<IBase> entryResources =
                                    entryDef.getChildByName("resource").getAccessor().getValues(nextEntry);
    ...
    private void write(JsonLikeWriter theEventWriter, String theChildName, BigDecimal theDecimalValue)
            throws IOException {
    ...
    private void writeExtensionsAsDirectChild(IBaseResource theResource, JsonLikeWriter theEventWriter,
            RuntimeResourceDefinition resDef, List<HeldExtension> extensions,
    ...
    private void writeOptionalTagWithTextNode(JsonLikeWriter theEventWriter, String theElementName,
            IPrimitiveDatatype<?> thePrimitive) throws IOException {
    ...
    private void writeOptionalTagWithTextNode(JsonLikeWriter theEventWriter, String theElementName, String theValue)
            throws IOException {
    ...
    private class HeldExtension implements Comparable<HeldExtension> {
        ...
        public int compareTo(HeldExtension theArg0) {
            ...
            String url2 =
                    theArg0.myDef != null ? theArg0.myDef.getExtensionUrl() : theArg0.myUndeclaredExtension.getUrl();
            url1 = defaultString(getExtensionUrl(url1));
            url2 = defaultString(getExtensionUrl(url2));
            return url1.compareTo(url2);
        }

        private void managePrimitiveExtension(final IBase theValue, final RuntimeResourceDefinition theResDef,
                final IBaseResource theResource, final JsonLikeWriter theEventWriter,
                final BaseRuntimeElementDefinition<?> def, final String childName) throws IOException {
        ...
        public void write(RuntimeResourceDefinition theResDef, IBaseResource theResource, JsonLikeWriter theEventWriter)
                throws IOException {
            if (myUndeclaredExtension != null) {
                 ...
                 * See #327
                 */
                List<? extends IBase> preProcessedValue =
                        preProcessValues(myDef, theResource, Collections.singletonList(myValue), myChildElem);
                ...
                if (def == null && IBaseReference.class.isAssignableFrom(myValue.getClass())) {
                    def = myDef.getChildElementDefinitionByDatatype(myContext.getVersion().getResourceReferenceType());
                }
        ...
        private void writeUndeclaredExtension(RuntimeResourceDefinition theResDef, IBaseResource theResource,
                JsonLikeWriter theEventWriter, IBaseExtension<?, ?> ext) throws IOException {
            ...
            if (noValue && ext.getExtension().isEmpty()) {
                 ...
                 */
                value = JsonParser.super.preProcessValues(myDef, theResource, Collections.singletonList(value),
                    myChildElem).get(0);
                ...
                if (childName == null) {
                    childName =
                            "value" + WordUtils.capitalize(myContext.getElementDefinition(value.getClass()).getName());
                }
                BaseRuntimeElementDefinition<?> childDef = extDef.getChildElementDefinitionByDatatype(value.getClass());
                if (childDef == null) {
                    throw new ConfigurationException("Unable to encode extension, unrecognized child element type: "
                            + value.getClass().getCanonicalName());
                }
                encodeChildElementToStreamWriter(theResDef, theResource, theEventWriter, value, childDef, childName,
                    true, false, myParent, false);
